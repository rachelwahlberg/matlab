classdef OptiLoader<logging.Singleton
    ...
    methods % Public Access
        ...
        function files=getOptiFilesCombined(obj)
            ...
            files= optiTrack.OptiFileCombined(obj)
        ...
        function [ofs] = loadFile(obj, files)
            ...
            for ifile=1:numel(files)
                ...
                switch ext
                    ...
                    case '.csv'
                        opts=detectImportOptions(fullfile(path1,filename),"ReadVariableNames",false);
                        for i=1:numel(opts.VariableTypes)
                            opts.VariableTypes{i}='char';
                        end
                        opts.DataLines=[3 5];            
                        t=readtable(fullfile(path1,filename),opts);
