...
%rat = 'Neville_watertraining_jun12_2';
rat = 'Dean_training_jun23_1';%
% rat = 'test'
...
%%sound file 
bellSoundPath = 'PhoPlaySoundsMatlab/sounds/service-bell_daniel_simion.mp3';
...
fnamePorts = ['E:\Rachel\datapoints_' num2str(yyyymmdd(datetime)) '_'  t '_' rat '.txt'];
fIDd = fopen(fnamePorts,'a');

%%%%% start/transition times %%%%%

fnameTransition = ['E:\Rachel\transitions_' num2str(yyyymmdd(datetime)) '_'  t '_' rat '.txt'];
