function [] = run16ports_manualSwitch_withperformance
...
pumpOpen = 0.05;% .04; % in seconds, length of time water is delivered (small because of the gravity system)
