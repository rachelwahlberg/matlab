function [status,interval,index] = InIntervals_RW(values,intervals,varargin)
...
for i = 1:n,
    ...
    %more = find(values>=intervals(1)&values<=intervals(2));
    %more = FindInInterval(values,intervals);
