function X = LinearizeTrajectory_RW(x,y,onstem)%mazetype as final arg instead of onstem 
%X = LinearizeTrajectory(x,y,mazetype)
%
% Will Mau and Nat Kinsky
% edited Rachel Wahlberg 3/14/22
...
if strcmp(mazetype,'alternationYmaze') == 1
    centroidx = maze.centroid.x;
    centroidy = maze.centroid.y;
