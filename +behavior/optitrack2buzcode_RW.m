function optitrack = optitrack2buzcode_RW(varargin)
...
optitrack_temp.TotalFrames = str2double(dataArray{14}(1));
optitrack_temp.TotalExportedFrames = str2double(dataArray{16}(1));
optitrack_temp.RotationType = dataArray{18}(1);
optitrack_temp.LenghtUnit = dataArray{20}(1);
optitrack_temp.CoorinateSpace = dataArray{22}(1);
...
position = [-optitrack_temp.X,optitrack_temp.Z,optitrack_temp.Y]/parameters.unit_normalization; %100* before
