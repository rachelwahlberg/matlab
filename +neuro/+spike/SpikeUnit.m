classdef SpikeUnit < neuro.spike.SpikeUnitRaw
    ...
    methods
        ...
        function timesnew = getAbsoluteSpikeTimes(obj)
            ...
            %   Detailed explanation goes here
            ticd=obj.Time;
            timesnew=ticd.getRealTimeFor(double(obj.TimesInSamples.SpikeTimes));
        end

        function times = getTimes(obj)
            %METHOD1 Summary of this method goes here
            %   Detailed explanation goes here
            times=time.Sample(obj.TimesInSamples.SpikeTimes, ...
        ...
        function fireRate = getFireRate(obj,timebininsec)
            ...
            for iti=1:til.length
                ti=til.get(iti);
                endtimeinsec=seconds(ti.getEndTimeAbs-ti.getStartTimeAbs);
                ...
                tinew=time.TimeIntervalZT( ...
                    ti.getStartTimeAbs+seconds(TimeBinsInSec/2), ...
