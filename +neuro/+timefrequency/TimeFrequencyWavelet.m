classdef TimeFrequencyWavelet < neuro.timefrequency.TimeFrequencyMethod
    ...
    methods
        function obj = TimeFrequencyWavelet(frequencyInterests,...
            ...
            %   Detailed explanation goes here
            obj = obj@neuro.timefrequency.TimeFrequencyMethod(frequencyInterests);
            if nargin>2
        ...
        function aTimeFrequencyMap = execute(obj,...
            ...
            l.info(sprintf('go'));
            aTimeFrequencyMap=neuro.timefrequency.TimeFrequencyMapWavelet(...
